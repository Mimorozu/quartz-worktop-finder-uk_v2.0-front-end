  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-page-bg px-5 text-center">
      ...
      <div className="flex gap-3">
        ...
        <Link
          href="/"
          className="inline-flex items-center justify-center gap-2 rounded-xl border border-border px-8 py-3.5 font-semibold text-slate transition-all hover:border-gold/50"
        >
          Back to homepage
        </Link>
      </div>
